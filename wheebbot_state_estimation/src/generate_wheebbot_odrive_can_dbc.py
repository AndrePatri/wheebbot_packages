...
def main():
    ...
    OUTPUT_DBC_PATH = os.path.join(PACKAGE_DIR, 'config/CAN_config', 'odrive_cansimple.dbc')

    ######## DBC DATABASE FOR HANDLING ODRIVE DATA OVER CAN ########
    ...
    # 0x007 - Requested State (see https://docs.odriverobotics.com/api/odrive.axis.axisstate,
    # 1: IDLE, 2: startup sequence, 3: full calibration, 8: closed loop control)
    ...
    # Input mode: (1: INPUT_MODE_PASSTHROUGH, 6: INPUT_MODE_TORQUE_RAMP, others at https://docs.odriverobotics.com/api/odrive.controller.inputmode)
