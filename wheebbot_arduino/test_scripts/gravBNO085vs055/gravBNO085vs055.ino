/////////////////////////////////////////////// COMPARING GRAV PERFORMANCE BETWEEN BNO055 AND BNO085 (BNO055 offers much better gravity readings !!!!!) /////////////////////////////////////////////// 
/////////////////////////////////////////////// USEFUL DEFINITIONS ///////////////////////////////////////////////////
...
struct enabled_reports {
  ...
  const bool IS_SH2_GRAVITY = true;
...
void loop() {
  ...
  if (bno08x.getSensorEvent(&sensorValue)) {
    ...
    switch (sensorValue.sensorId) {
     ...
     bno.getEvent(&bno055Gyro, Adafruit_BNO055::VECTOR_GRAVITY);// using raw gyro message to actually encode gravity from BNO055 (for simplicity)
