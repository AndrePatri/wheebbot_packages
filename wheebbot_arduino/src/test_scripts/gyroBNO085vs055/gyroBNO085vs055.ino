/////////////////////////////////////////////// COMPARING GYRO PERFORMANCE BETWEEN BNO055 AND BNO085 (they agree quite reliably) /////////////////////////////////////////////// 
/////////////////////////////////////////////// USEFUL DEFINITIONS ///////////////////////////////////////////////////
...
void loop() {
  ...
  if (bno08x.getSensorEvent(&sensorValue)) {
    ...
    switch (sensorValue.sensorId) {
     ...
     src_p_raw_gyro_first_half.gyro_x=bno055Gyro.gyro.x;
     src_p_raw_gyro_first_half.gyro_y=bno055Gyro.gyro.y;
     src_p_raw_gyro_second_half.gyro_z=bno055Gyro.gyro.z;
